...
# Comprobamos si existe la columna 'Total Enrolled' (necesaria para poder correr el stremlit)
#  este paso fue necesario debido a inconvenientes al visualizar en Streamlit
